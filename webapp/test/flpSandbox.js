		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comindragestionprovisiones-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comindragestionprovisiones-display": {
								"semanticObject": "comindragestionprovisiones",
								"action": "display",
								"description": "App para la gestión de provisiones",
								"title": "Gestión de Provisiones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.indra.gestionprovisiones",
									"url": sap.ui.require.toUrl("com/indra/gestionprovisiones")
								}
							}
						}
					}
